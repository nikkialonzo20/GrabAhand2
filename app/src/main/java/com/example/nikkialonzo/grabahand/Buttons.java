...
public class Buttons extends AppCompatActivity {
    ...
    private void showUpdate(ArrayList<JobRequested> jobRequesteds) {
        ...
        for (int i = 0; i < jobRequestedArrayList.size(); i++) {
            ...
            final JobRequested jobRequested1, jobRequested2;
                ...
                if (jobRequested2.getStatus() == 1) {
                    ...
                    switch (jobRequested2.getJobId()) {
                        ...
                        case "100":
                            ...
                            break;
                        case "101":
                            handle = "Philippine Red Cross";
                            break;
                        default:
                            handle = "Selected establishment";
                            break;
                    }
                    ...
                    switch (jobRequested2.getJobId()) {
                        ...
                        case "100":
                            ...
                            break;
                        case "101":
                            handle1 = "Philippine Red Cross";
                            break;
                        default:
                            handle1 = "Selected establishment";
                            break;
                    }
                    ...
                    dialog.setNeutralButton("Request another establishment", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent();
                            Log.d("id: ", jobRequested2.getJobId() + "");
                            char type = String.valueOf(jobRequested2.getJobId()).charAt(0);
                            switch (type) {
                                case '1':
                                    intent.setClass(Buttons.this, HospitalActivity.class);
                                    break;
                                case '2':
                                    intent.setClass(Buttons.this, FireActivity.class);
                                    break;
                                case '3':
                                    intent.setClass(Buttons.this, PoliceActivity.class);
                                    break;
                                case '4':
                                    intent.setClass(Buttons.this, MechanicActivity.class);
                                    break;
                                default:
                                    intent.setClass(Buttons.this, Buttons.class);
                                    break;
                            }
                            startActivity(intent);
                            finish();
